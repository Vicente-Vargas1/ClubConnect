...
const Navbar = () => {
  ...
  }, [authUser, fetchPendingCount, fetchUnreadCount]);
      ...
      <div className="container mx-auto px-4 h-16">
        <div className="flex items-center justify-between h-full">
          ...
          <div className="flex items-center gap-2">
            ...
            {authUser && (
              <Link to="/" className="btn btn-sm gap-2 transition-colors hidden sm:flex">
            ...
            <Link to="/settings" className="btn btn-sm gap-2 transition-colors hidden sm:flex">
